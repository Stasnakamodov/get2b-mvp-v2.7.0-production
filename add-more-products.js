...
async function addMoreProducts() {
  ...
  // 1. Добавим товары в категорию "Дом и быт" к существующему поставщику Электроники
  ...
  // Добавим товары для дома к ТехноКомплект (расширяем ассортимент)
  const homeProducts = [
    {
      supplier_id: electronicSupplier.id,
      name: 'Умная розетка Xiaomi',
      product_name: 'Умная розетка Xiaomi',
    ...
    },
    {
      ...
      product_name: 'LED лампа умная Philips',
    ...
    },
    {
      ...
      product_name: 'Робот-пылесос Roborock',
    ...
    },
    {
      ...
      product_name: 'Очиститель воздуха Dyson',
  ...
  // 2. Добавим товары в категорию "Здоровье и медицина" к тому же поставщику
  const medicalProducts = [
    {
      supplier_id: electronicSupplier.id,
      name: 'Термометр бесконтактный',
      product_name: 'Термометр бесконтактный',
    ...
    },
    {
      ...
      product_name: 'Пульсоксиметр портативный',
    ...
    },
    {
      ...
      product_name: 'Тонометр автоматический',
  ...
  // 3. Добавим товары в категорию "Продукты питания" 
  const foodProducts = [
    {
      supplier_id: electronicSupplier.id,
      name: 'Кофемашина De`Longhi',
      product_name: 'Кофемашина De`Longhi',
    ...
    },
    {
      ...
      product_name: 'Блендер KitchenAid',
